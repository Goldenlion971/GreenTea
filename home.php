...
<head>
	...
	<title>Green Coffee - acceuil</title>
</head>
<body>
			...
			<div class="slider">
				<div class="slider__slider slide1">
					...
					<div class="slide-detail">
						...
						<a href="view_products.php" class="btn">acheter</a>
					</div>
			...
			<div class="row">
				...
				<div class="row-detail">
					...
					<div class="top-footer">
						<h1>une tasse de thé vert vous rend en bonne santé</h1>
					</div>
				</div>
			</div>
			<div class="box-container">
