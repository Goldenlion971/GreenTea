<header class="header">
	<div class="flex">
		...
		<?php }else{ ?>
			<div class="user-box">
				<p class="name">connectez vous ou enregistrez vous d'abord s'il vous plait!</p>
				<div class="flex-btn">
					<a href="login.php" class="btn" style="color: #000;">se connecter</a>
					<a href="register.php" class="btn" style="color: #000;">s'enregistrer</a>
				</div>
			</div>	
			<?php } ?>
	</div>
