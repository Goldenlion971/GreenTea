...
<body>
		...
		<div class="title2">
			<a href="home.php">acceuil </a><span>/ dashboard</span>
		</div>
			...
			<div class="read-post">
				...
				<form method="post">
					...
					<div class="flex-btn">
						...
						<button type="submit" name="delete" class="btn" onclick="return confirm('delete this post?')">supprimer</button>
						<a href="view_posts.php?id=<?= $post_id ?>" class="btn">retourner</a>
					</div>
				</form>
				<?php 
						}
