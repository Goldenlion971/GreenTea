...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="home.php">accueil </a><span>/ dashboard</span>
		</div>
		<section class="dashboard">
			...
			<div class="box-container">
				<div class="box">
					...
					<a href="update_profile.php" class="btn">télécharger le profil</a>
				</div>
				...
				<div class="box">
					...
					<p>produit ajouté</p>
					<a href="add_posts.php" class="btn">ajouter un nouveau message</a>
				</div>
				<div class="box">
					<?php 
					...
					<p>active posts</p>
					<a href="view_posts.php" class="btn">voir messages</a>
				</div>
			   ...
			   <div class="box">
			      ...
			      <p>total des commandes supprimées</p>
			   ...
			   <div class="box">
			      ...
			      <p>total des commandes passées</p>
			      <a href="admin_order.php" class="btn">voir les commandes</a>
			   </div>
			</div>
