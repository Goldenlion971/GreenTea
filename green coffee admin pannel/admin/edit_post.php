<?php 
	 ...
	 if (isset($_POST['save'])) {
	 	...
	 	$success_msg[] = 'messages mis à jour ';
...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="home.php">accueil </a><span>/ écrire un message </span>
		</div>
		<section class="post-editor">
			
			
			<h1 class="heading">écrire un message</h1>
			<?php 
				$post_id = $_GET['id'];
			...
			?>
			<div class="flex-btn">
				<a href="view_posts.php" class="option-btn">voir l'article</a>
				<a href="add_posts.php" class="btn">ajouter un message</a>
			</div>
			<?php } ?>
		</section>
	</div>
