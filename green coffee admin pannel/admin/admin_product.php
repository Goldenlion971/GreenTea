<?php 
	...
	if (isset($_GET['delete'])) {
		...
		$select_delete_image = mysqli_query($conn, "SELECT image FROM `products` WHERE id = '$delete_id'") or die('la requête a échoué');
		$fetch_delete_image = mysqli_fetch_assoc($select_delete_image);
		unlink('image/'.$fetch_delete_image['image']);

		mysqli_query($conn, "DELETE FROM `products` WHERE id = '$delete_id'") or die('la requête a échoué');
		mysqli_query($conn, "DELETE FROM `cart` WHERE pid = '$delete_id'") or die('la requête a échoué');
		mysqli_query($conn, "DELETE FROM `wishlist` WHERE pid = '$delete_id'") or die('la requête a échoué');
	...
	<section class="show-products">
		<div class="box-container">
			...
			<div class="box">
				...
				<a href="admin_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete" onclick="return confirm('je veux supprimer cet article');">supprimer</a>
			</div>
			<?php 
					}
				}else{
