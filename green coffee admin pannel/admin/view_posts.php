...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="home.php">accueil </a><span>/ tous les produits</span>
		</div>
		<section class="post-editor">
			...
			<h1 class="heading">votre message</h1>
			<div class="show-post">
				<div class="box-container"> 
					...
					<form method="post" class="box">
						...
						<div class="flex-btn">
							...
							<a href="read_posts.php?post_id=<?= $fetch_posts['id']; ?>" class="btn">voir l'article</a>
						</div>
					</form>
					<?php 
							}
