	...
	if (isset($_POST['place_order'])) {
		...
		if (isset($_GET['get_id'])) {
			...
			if ($get_product->rowCount() > 0) {
				...
				$warning_msg[] = "quelque chose s'est mal passé";
			}
...
<head>
	...
	<title>Green Coffee - paiment</title>
</head>
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="home.php">accueil </a><span>/ récapitulatif de paiement</span>
		</div>
                		...
                		<div class="flex">
                			<div class="box">
                				<div class="input-field">
                					...
                					<input type="text" name="name" required maxlength="50" placeholder="Entrer votre nom" class="input">
                				</div>
                				<div class="input-field">
                					<p>votre numéro <span>*</span></p>
                					<input type="number" name="number" required maxlength="10" placeholder="Entrer votre numéro" class="input">
                				</div>
                				<div class="input-field">
                					<p>votre email <span>*</span></p>
                					<input type="email" name="email" required maxlength="50" placeholder="Enter votre email" class="input">
                				</div>
                				<div class="input-field">
                					<p>méthode de paiement <span>*</span></p>
                					<select name="method" class="input">
                						<option value="cash on delivery">paiement à la livraison</option>
                						<option value="credit or debit card">carte de crédit</option>
                			...
                			<div class="box">
                				<div class="input-field">
                					<p>adresse ligne 1 <span>*</span></p>
                					<input type="text" name="flat" required maxlength="50" placeholder="numéro de la rue" class="input">
                				</div>
                				<div class="input-field">
                					<p>adresse ligne 2 <span>*</span></p>
                					<input type="text" name="street" required maxlength="50" placeholder="nom de la rue " class="input">
                				</div>
                				<div class="input-field">
                					<p>ville <span>*</span></p>
                					<input type="text" name="city" required maxlength="50" placeholder="Entrer le nom de votre ville" class="input">
                				</div>
                				<div class="input-field">
                					<p>pays <span>*</span></p>
                					<input type="text" name="country" required maxlength="50" placeholder="Entrer le nom de votre pays" class="input">
                				</div>
                				<div class="input-field">
