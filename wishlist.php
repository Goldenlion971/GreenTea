 ...
 if (isset($_SESSION['user_id'])) {
	...
	if (isset($_POST['delete_item'])) {
		...
		if ($varify_delete_items->rowCount()>0) {
			...
			$success_msg[] = "articles supprimés des favoris ";
		}else{
			$warning_msg[] = "articles déjà supprimés des favoris ";
		}
	}
...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="home.php">accueil </a><span>/ favoris</span>
		</div>
		<section class="products">
			<h1 class="title">articles ahouté à la liste des favoris </h1>
			<div class="box-container">
				...
				<?php 
						...
						echo '<p class="empty">aucun acticle ajouté!</p>';
					}
				?>
			</div>
		</section>
